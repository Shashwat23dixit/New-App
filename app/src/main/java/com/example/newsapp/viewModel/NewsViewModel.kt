...
class NewsViewModel(
    ...
    lateinit var articles: LiveData<PagedList<Articles>>
    init {
        getBreakingNews("in")
    }
    ...
    fun insertArticle(article: Articles) = viewModelScope.launch {
    ...
    fun getBreakingNews() : LiveData<PagedList<Articles>>{
        return articles
    }
}
